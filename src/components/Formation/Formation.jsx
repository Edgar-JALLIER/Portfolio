            ...
            <div className="container-formation">
                <div className="formation formation--spe">
                    ...
                    <div className="formation-part2">
                        ...
                        <div className="formation-part2_poste">Développeur intégrateur Web</div>
                    </div>
                </div>
                ...
                <div className="formation formation--spe">
                    <div className="formation-part1">
                        ...
                        <div className="formation-part1_entreprise">Université de Nantes</div>
                    </div>
                        <img className="logo-formation" src={LogoUniv} alt="Université de Nantes" />
                    <div className="formation-part2">
                        <div className="formation-part2_durée">3 ans</div>
                        <div className="formation-part2_poste">Licence STAPS<br />Education et motricité</div>
                    </div>
                </div>
                ...
                <div className="formation">
                    <div className="formation-part1">
                        ...
                        <div className="formation-part1_entreprise">Lycée Jacques Prévert - Savenay</div>
                    </div>
                    <img className="logo-formation" src={LogoBac} alt="baccalauréat" />
            
                    <div className="formation-part2">
                        <div className="formation-part2_durée">3 ans</div>
                        <div className="formation-part2_poste">Bac économique et social</div>
                    </div>
                </div>
