    ...
    <div className="section-card">
            ...
            <div className="couleur-card">
                <div className="logo">
                    ...
                    <div className="infos">
                        ...
                        <h4 className="infos-description">Création d'une application web de location immobilière avec React en singlepage.</h4>
                        ...
                        <div className="langages-position">
                            ...
                            <div className="langages-infos">
                                <img className="logo-langage" src={logoReactRouter} alt="React" />
                                <p>React Router</p>
                            </div>
                            <div className="langages-infos">
                ...
                <a className="moreInfo" href="https://p7-kasa.netlify.app/" target="_blank" rel="noopener noreferrer">Explorer<div className="icon-link"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></div></a>
            </div>
        </div>
        ...
        <div className="container" onMouseMove={(ev) => handleMouseMove2(ev)} onMouseLeave={(e) => handleMouseLeave(e)} onMouseEnter={(e) => handleMouseEnter(e)}>
            <div className="couleur-card">
                <div className="logo">
                    ...
                    <div className="infos">
                        <div className="infos-underline"></div>
                        <h4 className="infos-description">Construction d'une API sur laquelle on peut effectuer des opérations CRUD (Create, Read, Update, Delete) de manière sécurisée.</h4>
                        <h3>Langages / Frameworks utilisés :</h3>
                        <div className="langages-position">
                            <div className="langages-infos">
                                <img className="logo-langage" src={logoNodeJs} alt="Node.JS" />
                                <p>Node.JS</p>
                            </div>
                            <div className="langages-infos">
                                <img className="logo-langage" src={logoExpress} alt="Express" />
                                <p>Express</p>
                            </div>
                            <div className="langages-infos">
                                <img className="logo-langage" src={logoMongoDB} alt="MongoDB" />
                                <p>MongoDB</p>
                            </div>
                        </div>
                    </div>
                <a className="moreInfo" href="https://github.com/Edgar-JALLIER/P6-backend" target="_blank" rel="noopener noreferrer">Explorer<div className="icon-link"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></div></a>
            </div>
        </div>
        ...
        <div className="container" onMouseMove={(ev) => handleMouseMove2(ev)} onMouseLeave={(e) => handleMouseLeave(e)} onMouseEnter={(e) => handleMouseEnter(e)}>
            <div className="couleur-card">
                <div className="logo">
                    ...
                    <div className="infos">
                        <div className="infos-underline"></div>
                        <h4 className="infos-description">Construction d'un site de e-commerce avec une page d'accueil, une page produit, une page panier et une page de confirmation.</h4>
                ...
                <a className="moreInfo" href="https://github.com/Edgar-JALLIER/P5-Kanap" target="_blank" rel="noopener noreferrer">Explorer<div className="icon-link"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></div></a>
            </div>
        </div>
        ...
        <div className="container" onMouseMove={(ev) => handleMouseMove2(ev)} onMouseLeave={(e) => handleMouseLeave(e)} onMouseEnter={(e) => handleMouseEnter(e)}>
            <div className="couleur-card">
                <div className="logo">
                    <div className="fond-couleur"></div>
                    <img src={logoPanthere} alt="logo" className="img-logo--panthere"/>
                </div>

                    <div className="infos">
                        <div className="infos-underline"></div>
                        <h4 className="infos-description">Optimisation du SEO d'un site web existant en utilisant "Lighthouse" et "PageSpeed Insights".</h4>
                        <h3>Langages utilisés :</h3>
                        <div className="langages-position">
                ...
                <a className="moreInfo" href="https://edgar-jallier.github.io/P4-La_Panthere/" target="_blank" rel="noopener noreferrer">Explorer<div className="icon-link"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></div></a>
            </div>
        </div>
        ...
        <div className="container" onMouseMove={(ev) => handleMouseMove2(ev)} onMouseLeave={(e) => handleMouseLeave(e)} onMouseEnter={(e) => handleMouseEnter(e)}>
            <div className="couleur-card">
                <div className="logo">
                    ...
                    <div className="infos">
                        <div className="infos-underline"></div>
                        <h4 className="infos-description">Transformation d'une maquette en site web avec ajout d'animations CSS et totalement responsive.</h4>
                        <h3>Langages utilisés :</h3>
                        <div className="langages-position">
                ...
                <a className="moreInfo" href="https://edgar-jallier.github.io/P3-Ohmyfood/" target="_blank" rel="noopener noreferrer">Explorer<div className="icon-link"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></div></a>
            </div>
        </div>
        ...
        <div className="container" onMouseMove={(ev) => handleMouseMove2(ev)} onMouseLeave={(e) => handleMouseLeave(e)} onMouseEnter={(e) => handleMouseEnter(e)}>
            <div className="couleur-card">
                <div className="logo">
                    ...
                    <div className="infos">
                        <div className="infos-underline"></div>
                        <h4 className="infos-description">Transformation d'une maquette en site web totalement responsive.</h4>
                        <h3>Langages utilisés :</h3>
                        <div className="langages-position">
