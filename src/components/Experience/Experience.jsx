            ...
            <div className="container-experiences">
                ...
                <div className="experience">
                    ...
                    <div className="experience-part2">
                        ...
                        <div className="experience-part2_poste">Développeur SharePoint stagiaire</div>
                    </div>
                </div>


                <h2 className="experience-type experience-type--spe">Autres expériences</h2>
                <div className="experience experience--spe">
                    <div className="experience-part1">
                        ...
                        <img className="logo-entreprise--Laposte" src={LogoLaposte} alt="la poste" />
                    <div className="experience-part2">
                ...
                <div className="experience">
                    <div className="experience-part1">
                        ...
                        <div className="experience-part1_entreprise">Collège Rosa Parks</div>
                    </div>
                    <img className="logo-entreprise" src={LogoEN} alt="éducation nationale" />
            
                    <div className="experience-part2">
                        <div className="experience-part2_durée">1 an</div>
                        <div className="experience-part2_poste">Professeur d'EPS stagiaire</div>
                    </div>
                </div>
            </div>
        </section>
